            ...
            <nav aria-label="breadcrumb">
                ...
                <div class="form-list">
                    ...
                    <div class="form-radio">
                        <input type="radio" name="pay" id="" value = "account" <?php if($balance <  $total){ echo 'disabled';} ?> > <span>Trừ tiền trong tài khoản Timphong365 (TK chính: <?php echo number_format((int) $balance,0,",",".")." đồng)"; ?></span>
